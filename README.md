...
- создать папку codejam-image-api. Все файлы проекта должны находиться в папке с именем "codejam-image-api". Организация кода внутри папки на ваше усмотрение.
